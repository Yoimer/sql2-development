<?php
  ...
  function count_pages_by_subject_id($subject_id, $options=[]) {
    ...
    // COUNT(id) returns how many id there are
    // just go and bring back the id, tell me how many ids you found as a result
  ...
  function validate_admin($admin, $options=[]) {
    ...
    // set a default value if none is found in php7.0
    // in this case if $options['password_required'] comes empty
    // it will automatically set a true value on it
  ...
  function update_admin($admin) {
    ...
    // if it was not sent, the of course it is not required
    // we're gonna leave it alone and we're not going to do the update
